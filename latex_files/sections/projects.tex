...
%    \begin{itemize}
%      \item Devised a matrix factorisation-based recommender system to predict effective drugs for treating several mental illnesses, given a patient's history with other drugs.
